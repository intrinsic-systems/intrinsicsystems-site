// apps/coresrc/WelcomeScreen.tsx
...
export const WelcomeScreen: React.FC<Props> = ({
  ...
  return (
    <div className="o-page o-welcome-page">
      <header className="o-page-header o-welcome-page-header">
        ...
        <div className="o-page-subtitle">
          Establish a structured enterprise capability baseline across
          governance, planning, information, lifecycle decision-making, and
      ...
      <main className="o-page-grid o-page-grid--hero">
        <section className="o-page-main">
          ...
          <p className="o-text-lead o-welcome-copy">
          ...
          <p className="o-text-lead o-welcome-copy o-welcome-copy--last">
          ...
          <div className="o-action-row o-welcome-actions">
          ...
          <div className="o-text-small o-welcome-note">
