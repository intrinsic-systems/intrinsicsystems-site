...
function StepIcon({ step }: { step: number }) {
  ...
  return (
    <div className="o-step-icon" aria-hidden="true">
      {symbol}
    </div>
  );
}
...
export const OnboardingWizard: React.FC<Props> = ({
  ...
  return (
    <div className="o-page o-flow-page">
      <div className="o-page-header o-flow-page-header">
      ...
      <main className="o-page-grid o-flow-layout">
        <section className="o-page-main">
          <div className="o-card o-flow-card">
            <PageIntro
            ...
            {step === 2 && (
              <div className="o-form-grid">
                ...
                <p className="o-text-small o-flow-helper-copy">
