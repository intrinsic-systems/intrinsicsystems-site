  ...
  return (
    <div className="o-core-shell">
      <ISControlLayer
        ...
        onHomeClick={() => navigate("/core/start")}
        onPrototypeClick={() => navigate("/core/start")}
      />

      <div className="o-core-shell__content">
        <div className="o-workspace-frame o-core-workspace-frame">
